...
class MainActivity : AppCompatActivity(), OpenProductDetails, AccountProfileNavigation,
    AuthNavigationListener, OpenProductDetailsFromFavourites {
    ...
    override fun openProductDetailsFromFavourites(bundle: Bundle) {
        navController.navigate(R.id.action_fromFavourites_to_Details, bundle)
    }
}